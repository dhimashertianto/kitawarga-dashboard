...
import { columns } from "@/components/pages/accounts/table/data"; // Import data
import { RenderCell } from "@/components/pages/accounts/table/render-cells"; // Import RenderCell function
