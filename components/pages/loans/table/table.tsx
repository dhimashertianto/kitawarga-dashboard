...
import { columns } from "@/components/pages/loans/table/data"; // Import data
import { RenderCell } from "@/components/pages/loans/table/render-cells"; // Import RenderCell function
