  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="hidden md:flex flex-1 relative flex items-center justify-center p-6">
        ...
        <div className="z-10">
          <h1 className="font-bold text-[45px]">Kita Warga</h1>
          <div className="font-light text-slate-400 mt-4">
            KitaWarga adalah sebuah platform untuk pengurus dan warga dalam
            mengelola lingkungan warga dan Semua Kebutuhan Perumahan dalam satu
            Platform.
          </div>
        </div>
      </div>
